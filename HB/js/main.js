...
camera.position.z = objToRender === "dino" ? 25 : 100;
...
document.addEventListener('mousedown', () => {
  isMouseDown = true;
  controls.enabled = true; // Enable OrbitControls rotation
});

document.addEventListener('mouseup', () => {
  isMouseDown = false;
  controls.enabled = false; // Disable OrbitControls rotation
});

document.addEventListener('mousemove', (e) => {
  mouseX = e.clientX;
  mouseY = e.clientY;
  if (object && objToRender === "eye" && !isMouseDown) {
